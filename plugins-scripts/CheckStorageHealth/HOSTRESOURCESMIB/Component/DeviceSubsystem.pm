package CheckStorageHealth::HOSTRESOURCESMIB::Component::DeviceSubsystem;
...
sub init {
  ...
  $self->get_snmp_tables('HOST-RESOURCES-MIB', [
      ['devices', 'hrDeviceTable', 'CheckStorageHealth::HOSTRESOURCESMIB::Component::DeviceSubsystem::Device'],
  ]);
}

package CheckStorageHealth::HOSTRESOURCESMIB::Component::DeviceSubsystem::Device;
