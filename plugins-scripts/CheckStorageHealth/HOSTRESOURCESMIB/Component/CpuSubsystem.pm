package CheckStorageHealth::HOSTRESOURCESMIB::Component::CpuSubsystem;
...
sub init {
  ...
  $self->get_snmp_tables('HOST-RESOURCES-MIB', [
      ['cpus', 'hrProcessorTable', 'CheckStorageHealth::HOSTRESOURCESMIB::Component::CpuSubsystem::Cpu'],
  ]);
  foreach (@{$self->{cpus}}) {
...
package CheckStorageHealth::HOSTRESOURCESMIB::Component::CpuSubsystem::Cpu;
