package CheckStorageHealth::HOSTRESOURCESMIB::Component::EnvironmentalSubsystem;
...
sub init {
  ...
  $self->{disk_subsystem} =
      CheckStorageHealth::HOSTRESOURCESMIB::Component::DiskSubsystem->new();
  $self->{device_subsystem} =
      CheckStorageHealth::HOSTRESOURCESMIB::Component::DeviceSubsystem->new();
}
