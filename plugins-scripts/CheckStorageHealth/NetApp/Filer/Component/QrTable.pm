package CheckStorageHealth::NetApp::Filer::Component::QrSubsystem;
our @ISA = qw(CheckStorageHealth::NetApp::Device);
...
sub init {
  ...
  $self->get_snmp_tables("NETAPP-APPLIANCE-MIB", [
      ["qrs", "qrTable", "CheckStorageHealth::NetApp::Filer::Component::QrSubsystem::Qr"],
  ]);
}
