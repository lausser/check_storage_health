package CheckStorageHealth::UCDMIB::Component::DiskSubsystem;
...
sub init {
  ...
  $self->get_snmp_tables('UCD-SNMP-MIB', [
      ['disks', 'dskTable', 'CheckStorageHealth::UCDMIB::Component::DiskSubsystem::Disk',
          sub {
            my ($self) = @_;
...
package CheckStorageHealth::UCDMIB::Component::DiskSubsystem::Disk;
