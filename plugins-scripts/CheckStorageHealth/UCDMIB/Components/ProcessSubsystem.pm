package CheckStorageHealth::UCDMIB::Component::ProcessSubsystem;
...
sub init {
  ...
  $self->get_snmp_tables('UCD-SNMP-MIB', [
      ['processes', 'prTable', 'CheckStorageHealth::UCDMIB::Component::ProcessSubsystem::Process',
        sub {
          my ($self) = @_;
...
package CheckStorageHealth::UCDMIB::Component::ProcessSubsystem::Process;
