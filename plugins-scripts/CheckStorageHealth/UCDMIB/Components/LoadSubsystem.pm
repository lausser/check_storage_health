package CheckStorageHealth::UCDMIB::Component::LoadSubsystem;
...
sub init {
  ...
  $self->get_snmp_tables('UCD-SNMP-MIB', [
      ['loads', 'laTable', 'CheckStorageHealth::UCDMIB::Component::LoadSubsystem::Load'],
  ]);
}
...
package CheckStorageHealth::UCDMIB::Component::LoadSubsystem::Load;
