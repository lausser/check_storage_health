package CheckStorageHealth::QNAP::QuTShero::Component::CacheSubsystem;
our @ISA = qw(Monitoring::GLPlugin::SNMP::Item);

sub init {
  my ($self) = @_;
  $self->get_snmp_tables("LEFTHAND-NETWORKS-NSM-INFO-MIB", [
    ["caches", "infoCacheTable", "CheckStorageHealth::QNAP::QuTShero::Component::CacheSubsystem::Cache"],
  ]);
}


package CheckStorageHealth::QNAP::QuTShero::Component::CacheSubsystem::Cache;
