...
sub init {
  ...
  $self->get_snmp_tables('HOST-RESOURCES-MIB', [
      ['storages', 'hrStorageTable', 'Classes::HOSTRESOURCESMIB::Component::DiskSubsystem::Storage', sub { my $o = shift; return ($o->{hrStorageType} eq 'hrStorageFixedDisk' and $self->filter_name($o->{hrStorageDescr})) }],
      ['filesystems', 'hrFSTable', 'Classes::HOSTRESOURCESMIB::Component::DiskSubsystem::FS'],
  ]);
...
package Classes::HOSTRESOURCESMIB::Component::DiskSubsystem::FS;
