package Classes::Dell::Storagecenter::Component::NodeSubsystem;
our @ISA = qw(Monitoring::GLPlugin::SNMP::Item);

sub init {
  my ($self) = @_;
  $self->get_snmp_tables("DELL-STORAGE-SC-MIB", [
    ["nodes", "scServerTable", "Classes::Dell::Storagecenter::Component::NodeSubsystem::Node"],
  ]);
}


package Classes::Dell::Storagecenter::Component::NodeSubsystem::Node;
...
package Classes::Dell::Storagecenter::Component::NodeSubsystem::CNode;
our @ISA = qw(Monitoring::GLPlugin::SNMP::TableItem);
