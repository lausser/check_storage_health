package Classes::Dell::Storagecenter::Component::DiskSubsystem;
our @ISA = qw(Monitoring::GLPlugin::SNMP::Item);

sub init {
  my ($self) = @_;
  $self->get_snmp_tables("DELL-STORAGE-SC-MIB", [
    ["disks", "scDiskTable", "Classes::Dell::Storagecenter::Component::DiskSubsystem::Disk"],
  ]);
}


package Classes::Dell::Storagecenter::Component::DiskSubsystem::Disk;
