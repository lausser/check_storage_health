package Classes::Synology::Component::DiskSubsystem;
our @ISA = qw(Monitoring::GLPlugin::SNMP::Item);

sub init {
  my ($self) = @_;
  $self->get_snmp_tables("SYNOLOGY-DISK-MIB", [
    ["disks", "diskTable", "Classes::Synology::Component::DiskSubsystem::Disk"],
  ]);
}


package Classes::Synology::Component::DiskSubsystem::Disk;
