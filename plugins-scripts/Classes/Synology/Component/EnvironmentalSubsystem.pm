package Classes::Synology::Component::EnvironmentalSubsystem;
...
sub init {
  ...
  $self->init_subsystems([
      ["disk_subsystem", "Classes::Synology::Component::DiskSubsystem"],
      ["raid_subsystem", "Classes::Synology::Component::RaidSubsystem"],
  ]);
}
