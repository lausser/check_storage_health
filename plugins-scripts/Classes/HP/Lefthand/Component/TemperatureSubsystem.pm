package Classes::HP::Lefthand::Component::TemperatureSubsystem;
our @ISA = qw(Monitoring::GLPlugin::SNMP::Item);

sub init {
  my ($self) = @_;
  $self->get_snmp_tables("LEFTHAND-NETWORKS-NSM-INFO-MIB", [
    ["temperatures", "infoTemperatureSensorTable", "Classes::HP::Lefthand::Component::TemperatureSubsystem::Temperature"],
  ]);
}


package Classes::HP::Lefthand::Component::TemperatureSubsystem::Temperature;
