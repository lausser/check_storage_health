package Classes::HP::Lefthand::Component::RaidSubsystem;
...
sub init {
  ...
  $self->get_snmp_tables("LEFTHAND-NETWORKS-NSM-STORAGE-MIB", [
    ["raids", "storageRaidTable", "Classes::HP::Lefthand::Component::RaidSubsystem::Raid"],
    ["osraids", "storageOsRaidTable", "Classes::HP::Lefthand::Component::RaidSubsystem::OSRaid"],
  ]);
}
...
package Classes::HP::Lefthand::Component::RaidSubsystem::Raid;
...
package Classes::HP::Lefthand::Component::RaidSubsystem::OSRaid;
our @ISA = qw(Monitoring::GLPlugin::SNMP::TableItem);
