package Classes::HP::Lefthand::Component::CacheSubsystem;
our @ISA = qw(Monitoring::GLPlugin::SNMP::Item);

sub init {
  my ($self) = @_;
  $self->get_snmp_tables("LEFTHAND-NETWORKS-NSM-INFO-MIB", [
    ["caches", "infoCacheTable", "Classes::HP::Lefthand::Component::CacheSubsystem::Cache"],
  ]);
}


package Classes::HP::Lefthand::Component::CacheSubsystem::Cache;
