package Classes::NetApp::Filer::Component::DiskSubsystem;
...
sub init {
  ...
  $self->get_snmp_tables("NETAPP-MIB", [
      ...
      ["vraids", "raidVTable", "Classes::NetApp::Filer::Component::RaidSubsystem::VRaid"],
  ]);
}
...
package Classes::NetApp::Filer::Component::RaidSubsystem::VRaid;
