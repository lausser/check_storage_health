package Classes::NetApp::Filer::Component::PlexSubsystem;
...
sub init {
  ...
  $self->get_snmp_tables("NETAPP-MIB", [
      ["plexs", "plexTable", "Classes::NetApp::Filer::Component::PlexSubsystem::Plex"],
  ]);
}
...
package Classes::NetApp::Filer::Component::PlexSubsystem::Plex;
